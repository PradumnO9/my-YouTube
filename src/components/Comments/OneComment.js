    ...
    <div className="flex bg-gray-100 p-2 shadow-sm rounded-lg my-2">
      ...
      <div className="px-3">
        ...
        <p className="flex items-center mt-2">
          <div className="cursor-pointer p-1 hover:bg-gray-300 rounded-full"><AiOutlineLike size={20} /></div>
          <h1 className="mx-1">{likeCount}</h1>
          <h1 className="text-sm ml-5 cursor-pointer p-1 font-bold hover:bg-gray-300 rounded-full">Reply</h1>
        </p>
      </div>
    </div>
  );
